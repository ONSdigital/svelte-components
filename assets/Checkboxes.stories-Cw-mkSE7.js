...
\`\`\`
`,re={title:"Inputs/Checkboxes",component:W,tags:["autodocs"],argTypes:{},parameters:U(oe)},{Story:L}=Y(),P=[{id:"ice-cream",label:"Ice cream",checked:!0},{id:"sprinkles",label:"Sprinkles",description:"Highly recommended!",checked:!1},{id:"disabled",label:"Disabled option",checked:!1,disabled:!0}];var de=b("<!> <!> <!>",1),pe=b("<!> <!> <!>",1);function z(D,e){$(e,!1),R();var c=pe(),m=O(c);const u=g(()=>({label:"Select items",items:P}));L(m,{name:"Default",get args(){return _(u)},parameters:{__svelteCsf:{rawCode:"<Checkboxes {...args} />"}}});var r=l(m,2);const S=g(()=>({items:P,compact:!0}));L(r,{name:"Compact without label",get args(){return _(S)},parameters:{__svelteCsf:{rawCode:"<Checkboxes {...args} />"}}});var f=l(r,2);const w=g(()=>Z(ce));L(f,{name:"Individually defined checkboxes",asChild:!0,parameters:{..._(w),__svelteCsf:{rawCode:`<Checkboxes label="Select items">
