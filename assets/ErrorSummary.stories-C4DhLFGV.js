import{p as b,f as l,i as $,t as g,j as e,J as E,k as s,l as M,m as O,G as n,K as S,O as F,A as N,W as R,h as A,I as W,X}from"./iframe-CqVOxj15.js";import{w as z,c as H,i as Q,d as U,a as Y}from"./create-runtime-stories-BvtLznAC.js";import{s as P}from"./style-CNURdi_Z.js";import{e as Z,i as ee}from"./each-C2rzIKO7.js";import{s as re}from"./slot-BP_Qo1ZM.js";import{s as te}from"./attributes-TF4kmMjJ.js";import{s as se}from"./class-B9SFUanI.js";import{L as ae}from"./List-BaGRA-8C.js";import"./attributes-q36Eg1F8.js";import"./html-C2KUQu_E.js";var oe=l("<a> </a>"),ie=l("<li><!></li>"),ne=l('<div aria-labelledby="alert" role="alert" tabindex="-1"><div class="ons-panel__header"><h2 id="alert" data-qa="error-header" class="ons-panel__title ons-u-fs-r--b"> </h2></div> <div class="ons-panel__body"><!> <!></div></div>');function _(d,r){let t=b(r,"title",8,null),a=b(r,"items",24,()=>[]),h=b(r,"cls",8,null);var m=ne(),f=s(m),y=s(f),w=s(y),p=E(f,2),v=s(p);{var x=c=>{ae(c,{mode:"number",children:(q,_e)=>{var T=M(),I=O(T);Z(I,1,a,ee,(L,u)=>{var k=ie(),B=s(k);{var G=o=>{var i=oe(),K=s(i);g(()=>{te(i,"href",n(u).href),S(K,n(u).label)}),e(o,i)},J=o=>{var i=F();g(()=>S(i,n(u).label)),e(o,i)};$(B,o=>{n(u).href?o(G):o(J,!1)})}e(L,k)}),e(q,T)},$$slots:{default:!0}})};$(v,c=>{Array.isArray(a())&&c(x)})}var D=E(v,2);re(D,r,"default",{},null),g(()=>{se(m,1,`ons-panel ons-panel--error ${h()??""}`,"svelte-15gtk6r"),S(w,t())}),e(d,m)}_.__docgen={data:[{name:"title",visibility:"public",description:"Defines the title of the error",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:"null"},{name:"items",visibility:"public",description:"Define an array of errors/issues in the format {label, href?}",keywords:[],kind:"let",type:{kind:"type",type:"array",text:"object[]"},static:!1,readonly:!1,defaultValue:"[]"},{name:"cls",visibility:"public",description:"Optional: Set an additional CSS class for the component",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:"null"}],name:"ErrorSummary.svelte"};const le=`A panel to summarise errors on a form/input. The errors can be defined in an \`items\` array, or as plain text/html within the component.
