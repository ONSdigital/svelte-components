import{p as B,j as f,f as b,Z as C,k as r,e as g,h as k,_ as w,n as I,t as _,V as S,q as $}from"./iframe-oyiClAn3.js";import{w as D,c as L,i as G,d as A}from"./create-runtime-stories-C_UJKXQA.js";import{s as O}from"./style-CcY6orqc.js";import{B as y}from"./Button-BIO8ly4f.js";import"./attributes-Co-1QMVx.js";import"./slot-BP_Qo1ZM.js";import"./attributes-DnyOSBr9.js";import"./class-Dzh9Da8g.js";import"./Icon-siD7z91l.js";import"./utils-VWytQRnm.js";import"./_commonjsHelpers-CqkleIqs.js";const T=`A button/link component that can be styled in various ways. It will render as an \`<a>\` link if it has an \`href\` property defined.\r
\r
<!-- prettier-ignore -->\r
\`\`\`html\r
<script>\r
...
\`\`\`\r
`,t=(d,s=C)=>{var a=P();let l;var c=I(a);y(c,w(s,{children:(o,u)=>{var i=S();_(()=>$(i,s().text)),g(o,i)},$$slots:{default:!0}})),_(()=>{var o;return l=O(a,"",l,{padding:"12px",background:((o=s())==null?void 0:o.variant)==="ghost"?"var(--ons-color-ocean-blue)":null})}),g(d,a)},H={title:"Inputs/Button",component:y,tags:["autodocs"],argTypes:{type:{options:["button","submit","reset"],control:{type:"select"}},variant:{options:["primary","secondary","ghost"],control:{type:"select"}},icon:{options:["","arrow","search","download","tick","print","externalLink"],control:{type:"select"}},iconPosition:{options:["before","after"],control:{type:"select"}}},parameters:D(T)},{Story:n}=A();var P=f("<div><!></div>"),j=f("<!> <!> <!> <!> <!> <!> <!> <!> <!>",1);function x(d,s){B(s,!1),G();var a=j(),l=b(a);n(l,{name:"Default",args:{text:"Primary button"},get template(){return t},parameters:{__svelteCsf:{rawCode:`<div\r
