import{a as N,j as o,k as c,n as f,t as k,e as t,q as M,c as A,f as h,g as _,p as z,o as x,h as F}from"./iframe-BMlGGSEh.js";import{w as J,c as j,i as q,d as L,a as V}from"./create-runtime-stories-DY8P5Zzy.js";import{e as B,i as E}from"./each-x1Fw04Zn.js";import{h as H}from"./html-vr7QzKP9.js";import{s as D}from"./slot-BP_Qo1ZM.js";var R=o('<div class="ons-timeline__item"><h2 class="ons-timeline__heading"> </h2> <div class="ons-timeline__content"><!></div></div>');function u(a,n){let s=N(n,"title",8,null);var e=R(),i=f(e),l=f(i),m=c(i,2),r=f(m);D(r,n,"default",{},null),k(()=>M(l,s())),t(a,e)}u.__docgen={data:[{name:"title",visibility:"public",description:"Title of timeline item",keywords:[],kind:"let",type:{kind:"type",type:"string",text:"string"},static:!1,readonly:!1,defaultValue:"null"}],name:"TimelineItem.svelte"};var G=o('<div class="ons-timeline"><!> <!></div>');function g(a,n){let s=N(n,"items",24,()=>[]);var e=G(),i=f(e);D(i,n,"default",{},null);var l=c(i,2);B(l,1,s,E,(m,r)=>{u(m,{get title(){return _(r).title},children:(T,$)=>{var y=A(),v=h(y);H(v,()=>_(r).content),t(T,y)},$$slots:{default:!0}})}),t(a,e)}g.__docgen={data:[{name:"items",visibility:"public",description:"Timeline items in the format {title, content}, where content can be an HTML string",keywords:[],kind:"let",type:{kind:"type",type:"array",text:"object[]"},static:!1,readonly:!1,defaultValue:"[]"}],name:"Timeline.svelte"};const K=`A component to display a linear record of past and future events.
