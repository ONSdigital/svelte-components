import{aJ as ne,x as he,aK as le,ab as R,p as b,ak as ce,am as fe,d as C,e as O,i as D,a as W,ad as P,q as i,g as e,P as de,al as ye,at as d,an as y,u as l,ae as N,f as xe,H as S}from"./iframe-sScITiDD.js";import{i as J,c as pe,w as ue,d as me,a as ge}from"./create-runtime-stories-zBo7-1R2.js";import{B as T}from"./BarChart-BCnu_582.js";import{C as H}from"./ColumnChart-lKFznmY3.js";import{L as j}from"./LineChart-46kBY8fs.js";import{S as k}from"./ScatterChart--LQlI-RO.js";import{D as ve}from"./DotPlotChart-CVdM4800.js";import"./DotPlotChart.svelte_svelte_type_style_lang-C4OQ2Uti.js";import"./preload-helper-Dp1pzeXC.js";import"./slot-BP_Qo1ZM.js";import"./style-rPNM_RJR.js";import"./attributes-DayBpKoh.js";import"./this-DzQxfD6Y.js";import"./misc-D9wx5MhO.js";import"./each-B9hld0ni.js";import"./attributes-BvtExsIM.js";import"./class-DEomZZNA.js";import"./Legend-CYz3yWXe.js";import"./defaultLocale-DJ2q5QjE.js";import"./linear-CZTuTj73.js";import"./band-C_9yQ5NZ.js";import"./actions-C-infV3j.js";import"./Labels-BkxyYEli.js";import"./svelte-head-CRwkrD2p.js";const ze=Symbol("NaN");function be(m,c,t){var x=new le(m),o=!ne();he(()=>{var n=c();n!==n&&(n=ze),o&&n!==null&&typeof n=="object"&&(n={}),x.ensure(n,t)})}function Se(m,c){R(c,!1);const t=de();let x=b(c,"section",8,null),o=b(c,"type",24,()=>{var u;return(u=x())==null?void 0:u.chartType}),n=b(c,"data",8,null),p=b(c,"options",8,null);const g=["left","right","top","bottom"],F=/^\[(?:'[^']*'|"[^"]*"|\d+(?:\.\d+)?)(,?)*]$/;function q(u,v,_,h){h||(h={chartType:u,data:v,..._});let s={},z={left:50,right:0,top:0,bottom:20};return Object.keys(h).filter(a=>!["type","chartType",...g.map(f=>`padding-${f}`)].includes(a)).forEach(a=>{F.test(h[a])?s[a]=JSON.parse(h[a]):s[a]=h[a]}),Array.isArray(h.data)&&Object.keys(h.data[0]).forEach(f=>{["x","y","z","r"].includes(f)?s[`${f}Key`]=f:s[f]=f}),g.forEach(a=>{h[`padding-${a}`]&&(z[a]=+h[`padding-${a}`])}),s.padding=z,!s.legend&&s.legend!==!1&&(s.legend=!!s.zKey),s}ce(()=>(i(o()),i(n()),i(p()),i(x())),()=>{ye(t,q(o(),n(),p(),x()))}),fe(),J();var L=C(),M=O(L);{var G=u=>{var v=C(),_=O(v);be(_,()=>(e(t),l(()=>e(t).data)),h=>{var s=C(),z=O(s);{var B=r=>{T(r,d(()=>e(t)))},a=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="bar"&&e(t).xKey&&e(t).yKey))),f=r=>{T(r,d(()=>e(t),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0}))},I=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="bar-highlight"&&e(t).xKey&&e(t).yKey))),U=r=>{H(r,d(()=>e(t)))},Q=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="column"&&e(t).xKey&&e(t).yKey))),V=r=>{H(r,d(()=>e(t),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0}))},X=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="column-highlight"&&e(t).xKey&&e(t).yKey))),Y=r=>{j(r,d(()=>e(t),{area:!1}))},Z=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="line"&&e(t).xKey&&e(t).yKey))),$=r=>{j(r,d(()=>e(t),{area:!1,color:"#bbb",lineWidth:1,legend:!1,snapTicks:!1,hover:!0,labels:!0}))},ee=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="line-highlight"&&e(t).xKey&&e(t).yKey))),te=r=>{k(r,d(()=>e(t)))},re=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="scatter"&&e(t).xKey))),oe=r=>{k(r,d(()=>e(t),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0,hover:!0,labels:!0}))},ae=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="scatter-highlight"&&e(t).xKey))),se=r=>{ve(r,d(()=>e(t)))},ie=y(()=>(i(o()),e(t),l(()=>o().toLowerCase()==="dotplot"&&e(t).xKey&&e(t).yKey)));D(z,r=>{e(a)?r(B):e(I)?r(f,1):e(Q)?r(U,2):e(X)?r(V,3):e(Z)?r(Y,4):e(ee)?r($,5):e(re)?r(te,6):e(ae)?r(oe,7):e(ie)&&r(se,8)})}W(h,s)}),W(u,v)};D(M,u=>{e(t)&&u(G)})}W(m,L),P()}const Oe=`A wrapper component that offers a simplified way to use charts with sensible preset defaults.
