...
</div>`}}}),w()}_.__docgen={data:[],name:"ErrorPanel.stories.svelte"};const R=I(_,K),X=["Default"],Z={...R.Default,tags:["svelte-csf-v5"]};export{Z as Default,X as __namedExportsOrder,K as default};
