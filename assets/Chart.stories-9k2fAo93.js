...
<Chart
  ...
  options="{options}"/>
\`\`\`
`,Ie=`In this use case, all of the data and config are passed into the component via a single \`section\` prop.
