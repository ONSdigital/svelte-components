import{A as b,f as m,m as w,V as x,G as a,h as s,J as c,j as v,I as C,W as y,k as L}from"./iframe-IP6ocM0a.js";import{w as H,c as T,i as $,d as P}from"./create-runtime-stories-BvMOJ_th.js";import{s as S}from"./style-CNURdi_Z.js";import{D as u}from"./Dropdown-C_24dBzt.js";import{o as r}from"./menuOptions-kj4WdJs_.js";import"./attributes-q36Eg1F8.js";import"./each-BQdT5JWw.js";import"./attributes-CBM4GyKF.js";import"./class-B9SFUanI.js";const Q=`A standard \`<select>\` component with Svelte bindings and events.
...
`,i=(o,n=x)=>{var e=j();S(e,"",{},{padding:"12px"});var t=L(e);u(t,y(n)),v(o,e)},A={title:"Form elements/Dropdown",component:u,tags:["autodocs"],argTypes:{},parameters:H(Q)},{Story:d}=P();var j=m("<div><!></div>"),k=m("<!> <!> <!>",1);function _(o,n){b(n,!1),$();var e=k(),t=w(e);const g=s(()=>({id:"topic",label:"Question topic",options:r}));d(t,{name:"Default",get args(){return a(g)},get template(){return i},parameters:{__svelteCsf:{rawCode:`<div style:padding="12px">
	...
	<Dropdown {...args} />
</div>`}}}),v(o,e),C()}_.__docgen={data:[],name:"Dropdown.stories.svelte"};const l=T(_,A),R=["Default","HiddenLabel","CustomPlaceholderText"],V={...l.Default,tags:["svelte-csf-v5"]},W={...l.HiddenLabel,tags:["svelte-csf-v5"]},z={...l.CustomPlaceholderText,tags:["svelte-csf-v5"]};export{z as CustomPlaceholderText,V as Default,W as HiddenLabel,R as __namedExportsOrder,A as default};
