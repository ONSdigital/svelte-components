import{A as _,f as m,m as h,V as f,J as s,j as u,I as x,W as I,k as b}from"./iframe-IP6ocM0a.js";import{w as W,c as C,i as w,d as D}from"./create-runtime-stories-BvMOJ_th.js";import{s as E}from"./style-CNURdi_Z.js";import{I as c}from"./Input-BkXi2aYc.js";import"./attributes-q36Eg1F8.js";import"./attributes-CBM4GyKF.js";import"./class-B9SFUanI.js";import"./input-B4kjuHnU.js";const y=`A standard \`<input>\` element with Svelte bindings and events.
...
`,t=(i,o=f)=>{var e=$();E(e,"",{},{padding:"12px"});var a=b(e);c(a,I(o)),u(i,e)},L={title:"Form elements/Input",component:c,tags:["autodocs"],argTypes:{},parameters:W(y)},{Story:n}=D();var $=m("<div><!></div>"),N=m("<!> <!> <!> <!> <!>",1);function v(i,o){_(o,!1),w();var e=N(),a=h(e);n(a,{name:"Default",args:{id:"text",label:"Enter some text"},get template(){return t},parameters:{__svelteCsf:{rawCode:`<div style:padding="12px">
	...
	<Input {...args} />
</div>`}}}),u(i,e),x()}v.__docgen={data:[],name:"Input.stories.svelte"};const r=C(v,L),F=["Default","WithHiddenLabel","WithDescription","NumericWithPrefix","InputError"],J={...r.Default,tags:["svelte-csf-v5"]},M={...r.WithHiddenLabel,tags:["svelte-csf-v5"]},O={...r.WithDescription,tags:["svelte-csf-v5"]},R={...r.NumericWithPrefix,tags:["svelte-csf-v5"]},V={...r.InputError,tags:["svelte-csf-v5"]};export{J as Default,V as InputError,R as NumericWithPrefix,O as WithDescription,M as WithHiddenLabel,F as __namedExportsOrder,L as default};
