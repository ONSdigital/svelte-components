import{z as ze,ap as be,I as Se,K as _e,a5 as Oe,a4 as We,aq as Ce,p as U,a as W,l as we,b as Ke,c as E,f as K,i as n,e as L,h as G,g as t,m as Le,s as Be,d as C,_ as c,j as De,o as w,k as I}from"./iframe-B3b0x8CI.js";import{i as M,w as Te,c as Ne,d as Ee,a as He}from"./create-runtime-stories-BDWGkGAJ.js";import{B as P}from"./BarChart-DCzPbS9Y.js";import{C as J}from"./ColumnChart-BpXpaBaF.js";import{L as q}from"./LineChart-ClzX1aaf.js";import{S as A}from"./ScatterChart-BiFFqExW.js";import{D as je}from"./DotPlotChart-BRUP1uuc.js";import"./DotPlotChart.svelte_svelte_type_style_lang-Cq450sDF.js";import"./slot-BP_Qo1ZM.js";import"./style-CcY6orqc.js";import"./attributes-Co-1QMVx.js";import"./this-CjIfBv2f.js";import"./misc-CwXbMbeG.js";import"./each-BB2t4dHV.js";import"./attributes-BVKlW9hW.js";import"./class-Dzh9Da8g.js";import"./Legend-BMjUDiSx.js";import"./defaultLocale-DJ2q5QjE.js";import"./linear-CZTuTj73.js";import"./band-BBFINFf0.js";import"./actions-I2uuP2Vv.js";import"./Labels-CMzFsp7b.js";import"./svelte-head-DUqDNX5C.js";function ke(b,h,e){var f=b,r=Ce,l,y=ze()?be:Se;_e(()=>{y(r,r=h())&&(l&&Oe(l),l=We(()=>e(f)))})}function Re(b,h){U(h,!1);const e=Le();let f=W(h,"section",8,null),r=W(h,"type",24,()=>{var d;return(d=f())==null?void 0:d.chartType}),l=W(h,"data",8,null),y=W(h,"options",8,null);const S=["left","right","top","bottom"],B=/^\[(?:'[^']*'|"[^"]*"|\d+(?:\.\d+)?)(,?)*]$/;function D(d,_,T,i){i||(i={chartType:d,data:_,...T});let a={},O={left:50,right:0,top:0,bottom:20};return Object.keys(i).filter(o=>!["type","chartType",...S.map(s=>`padding-${s}`)].includes(o)).forEach(o=>{B.test(i[o])?a[o]=JSON.parse(i[o]):a[o]=i[o]}),Array.isArray(i.data)&&Object.keys(i.data[0]).forEach(s=>{["x","y","z","r"].includes(s)?a[`${s}Key`]=s:a[s]=s}),S.forEach(o=>{i[`padding-${o}`]&&(O[o]=+i[`padding-${o}`])}),a.padding=O,!a.legend&&a.legend!==!1&&(a.legend=!!a.zKey),a}we(()=>(C(r()),C(l()),C(y()),C(f())),()=>{Be(e,D(r(),l(),y(),f()))}),Ke(),M();var k=E(),Q=K(k);{var V=d=>{var _=E(),T=K(_);ke(T,()=>t(e).data,i=>{var a=E(),O=K(a);{var R=s=>{P(s,c(()=>t(e)))},o=(s,X)=>{{var Y=x=>{P(x,c(()=>t(e),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0}))},$=(x,ee)=>{{var te=p=>{J(p,c(()=>t(e)))},re=(p,oe)=>{{var se=u=>{J(u,c(()=>t(e),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0}))},ae=(u,ie)=>{{var ne=m=>{q(m,c(()=>t(e),{area:!1}))},he=(m,le)=>{{var ce=g=>{q(g,c(()=>t(e),{area:!1,color:"#bbb",lineWidth:1,legend:!1,snapTicks:!1,hover:!0,labels:!0}))},fe=(g,de)=>{{var ye=v=>{A(v,c(()=>t(e)))},xe=(v,pe)=>{{var ue=z=>{A(z,c(()=>t(e),{color:"#bbb",colorSelect:"#206095",colorHighlight:"grey",overlayFill:!0,hover:!0,labels:!0}))},me=(z,ge)=>{{var ve=N=>{je(N,c(()=>t(e)))};n(z,N=>{r().toLowerCase()==="dotplot"&&t(e).xKey&&t(e).yKey&&N(ve)},ge)}};n(v,z=>{r().toLowerCase()==="scatter-highlight"&&t(e).xKey?z(ue):z(me,!1)},pe)}};n(g,v=>{r().toLowerCase()==="scatter"&&t(e).xKey?v(ye):v(xe,!1)},de)}};n(m,g=>{r().toLowerCase()==="line-highlight"&&t(e).xKey&&t(e).yKey?g(ce):g(fe,!1)},le)}};n(u,m=>{r().toLowerCase()==="line"&&t(e).xKey&&t(e).yKey?m(ne):m(he,!1)},ie)}};n(p,u=>{r().toLowerCase()==="column-highlight"&&t(e).xKey&&t(e).yKey?u(se):u(ae,!1)},oe)}};n(x,p=>{r().toLowerCase()==="column"&&t(e).xKey&&t(e).yKey?p(te):p(re,!1)},ee)}};n(s,x=>{r().toLowerCase()==="bar-highlight"&&t(e).xKey&&t(e).yKey?x(Y):x($,!1)},X)}};n(O,s=>{r().toLowerCase()==="bar"&&t(e).xKey&&t(e).yKey?s(R):s(o,!1)})}L(i,a)}),L(d,_)};n(Q,d=>{t(e)&&d(V)})}L(b,k),G()}const Ie=`A wrapper component that offers a simplified way to use charts with sensible preset defaults.\r
\r
...
<Chart\r
  ...
  options="{options}"/>\r
\`\`\`\r
`,Pe=`In this use case, all of the data and config are passed into the component via a single \`section\` prop.\r
\r
