...
\`\`\`\r
`,P=(h,e=ie)=>{var n=Ie();J(n,"",{},{padding:"12px"});var v=l(n);B(v,le(e)),m(h,n)},we={title:"Inputs/Radios",component:B,tags:["autodocs"],argTypes:{},parameters:se(ke)},{Story:E}=re();let U=[{id:"house",label:"House or bungalow",description:"Includes terraced, semi-detached and detached homes."},{id:"flat",label:"Flat, maisonette or apartment"},{id:"mobile",label:"Caravan or other mobile or temporary structure"}];var Ie=f("<div><!></div>"),Re=f("<!> <!> <!>",1),De=f("<div><!></div>"),Ce=f("<!> <!> <!>",1);function K(h,e){Z(e,!1),G();var n=Ce(),v=N(n);const q=O(()=>({label:"Select one",id:"radios",items:U}));E(v,{name:"Default",get args(){return V(q)},get template(){return P},parameters:{__svelteCsf:{rawCode:`<div style:padding="12px">\r
	<Radios {...args} />\r
...
</div>`}},children:(x,b)=>{var p=De();J(p,"",{},{padding:"12px"});var w=l(p);B(w,{label:"Select one",children:(I,R)=>{var r=Re(),o=N(r);j(o,{groupId:"radios",id:"house",label:"House or bungalow",description:"Includes terraced, semi-detached and detached homes."});var g=u(o,2);j(g,{groupId:"radios",id:"flat",label:"Flat, maisonette or apartment"});var D=u(g,2);j(D,{groupId:"radios",id:"mobile",label:"Caravan or other mobile or temporary structure"}),m(I,r)},$$slots:{default:!0}}),m(x,p)},$$slots:{default:!0}}),m(h,n),z()}K.__docgen={data:[],name:"Radios.stories.svelte"};const M=ne(K,we),Ae=["Default","CompactWithoutLabel","IndividuallyDefinedRadios"],Be={...M.Default,tags:["svelte-csf-v5"]},Ee={...M.CompactWithoutLabel,tags:["svelte-csf-v5"]},Me={...M.IndividuallyDefinedRadios,tags:["svelte-csf-v5"]};export{Ee as CompactWithoutLabel,Be as Default,Me as IndividuallyDefinedRadios,Ae as __namedExportsOrder,we as default};
